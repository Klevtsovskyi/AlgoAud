...
Реализуйте метод IsBalanced, который определит, является ли дерево сбалансированным
по высоте. Дерево называется сбалансированным по высоте, если для каждой вершины
высота ее левого и правого поддерева отличается не более чем на 1.
