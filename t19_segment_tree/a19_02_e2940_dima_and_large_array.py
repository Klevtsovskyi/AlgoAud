''' a19_02_e2940_dima_and_large_array.py
...
і до елементу з індексом i магічно додається d. Діма бавиться зі своїм масивом,
а мама час від часу задає йому питання — яка сума усіх чисел у масиві з
індексами від f до t? Проте мама дуже зайнята і не може задавати питання так
часто, як звичайно - усього вона задала не більше 1000 запитань. Діма легко
справився з цими запитаннями, а чи зможете Ви?

Вхідні дані:
У першому рядку знаходиться два цілих числа n та q (1 ≤ n ≤ 10^6,
1 ≤ q ≤ 5 * 10^5) - кількість елементів у масиві і сумарна кількість операцій
та запитів відповідно. У наступному рядку задано n чисел a1, a2, ..., an
...
починається з +, то це операція додавання. Далі йдуть i та d, обмеження на
